...
(function ($) {
  ...
  $(function () { 
    $(".hero-slides").vegas({
      slides: [{ src: "../FinalPos/images/hangout.jpg" }, { src: "../FinalPos/images/young-female-barista-wear-face-mask-serving-take-away-hot-coffee-paper-cup-consumer-cafe.jpg" }],
      timer: false, 
      animation: "kenburns",
    });
  });
